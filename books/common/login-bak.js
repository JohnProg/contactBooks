        ...
        return(
            <View style={styles.loginCon}>
                ...
                <View style={styles.loginBottom}>
                    <View style={styles.loginBottomTextCon}>
                    </View>
                    <View style={styles.loginBottomTextOv}>
                        <Text style={styles.loginBottomText}>还没有账号?</Text>
                    </View>
                    
                    <TouchableOpacity activeOpacity={0.7}>
                        <View style={[styles.loginFormReg,styles.marginTop10]}>
                            <Text style={styles.loginFormRegTxt}>注册</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                {
