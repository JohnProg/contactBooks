...
Conf.ACCESS_KEY = 'fGI-pdVBLwOm3rC72gFXSAjQr9aaFuTEdSga6ODv';
Conf.SECRET_KEY = 'tfDM1BiKlwmSieFlwYYVB1xhvXvJBrr6jgsPZ5CS';
...
export default class Aavatar extends Component{
    ...
    upLoadToQiniu(data){
        ...
        //Rpc.uploadFile(data.uri,  uptoken,formInput);
        console.log(Rpc);
        //console.log(11);
    }
    render(){
